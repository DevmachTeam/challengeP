...
use TncBzkrt\Config\Helpers\Redirect;
...
class Route
{
            ...
            if (preg_match($pattern, $url, $params)) {
                ...
                if (isset($props['redirect'])) {
                    ...
                    if (is_callable($callback)) {
                        ...
                        $controllerName = '\TncBzkrt\App\Controller\\' . $controllerName;
    ...
    {
        return str_replace("challenge/", null, $_SERVER['REQUEST_URI']);
    }
    ...
    public static function url(string $name, array $params = []): string
    {
        ...
        return "challenge/" . str_replace(array_map(fn($key) => ':' . $key, array_keys($params)), array_values($params), $route);
    }
